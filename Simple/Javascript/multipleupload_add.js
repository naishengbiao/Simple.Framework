...
function showResponse(data, textStatus) {
    if (data.msg == 1) {
        var str = "<li><img src=\"" + data.msbox + "\" onmouseover=\"ChangePreview('" + data.msbox + "');\" /><a onclick=\"dlstItems_Command(this,'" + data.msbox + "');\">删除</a><input name=\"hideFiles\" type=\"hidden\" value=\"" + data.msbox + "\"></li>";
...
//删除图片处理方法
function dlstItems_Command(obj, imgurl) {
