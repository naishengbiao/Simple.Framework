...
namespace Simple.DButils
{
    public sealed class SqlHelper
    {
        ...
        #region 属性
        //private static string Sqlconnstring = ConfigurationSettings.AppSettings["HYSC"];
        #endregion
        ...
        #region CreateConnection 创建链接对象
        //public static DbConnection CreateConnection()
        //{
        //    DbProviderFactory dbfactory = DbProviderFactories.GetFactory(dbfactory,);
