...
namespace Simple.Util
{
    public class ImagesUp
    {
        ...
        public class ImageUpload
        {
            ...
            private int _MaxSize = (1024 * 1024) * 10;//最大单个上传文件 (默认)
            ...
            private HttpPostedFile _hpFile;
            private string _InFileName = "";//非自动生成文件名设置。 
            private string _OutFileName = "";//输出实际文件名。
            ...
            private int _sHeight = 100;//设置生成缩略图的高度 
            private int _sWidth = 100;//设置生成缩略图的宽度
            ...
            private string _CopyIamgePath = System.Web.HttpContext.Current.Server.MapPath(@"~\") + @"images\t0102d67cd8096d41dd.png";//图片水印模式下的覆盖图片的实际地址
            #endregion
            ...
            public void Upload()
            {
                ...
                try
                {
                    ...
                    if (_IsCreateImg)
                    {
                        ...
                        newImg.Save(ImgFilePath, ImageFormat.Jpeg);
                        newImg.Dispose();
                        _Iss = true;
                    }
